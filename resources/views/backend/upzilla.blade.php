                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <th>Upzilla Bangla</th>
                                                <th>Upzilla English</th>
                                                <th>Category Name</th>
                                                <th>Status</th>
                                                <th>Action</th>
                                            </tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr id="item{{$data->id}}">
                                                <td>{{$data->name_bd}}</td>
                                                <td>{{$data->name_en}}</td>
                                                <td>{{$data->deshjureType->name_bd}}</td>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="parent_id" required id="parent_id" class="form-control custom-select">
                                                    ...
                                                    @foreach($get_category as $category)
                                                        <option value="{{$category->id}}">{{$category->name_bd}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
          ...
          <div class="modal fade" id="edit" role="dialog"  tabindex="-1" aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <form action="{{route('upzilla.update')}}"  method="post">
                  ...
                  <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Upzilla category</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
