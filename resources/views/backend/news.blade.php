                    ...
                    <form action="{{route('news.store')}}" enctype="multipart/form-data" class="floating-labels" method="post" id="news">
                        ...
                        <div class="form-body">
                            <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <span>Keywords</span>
                                                     ...
                                                     <div class="tags-default">
                                                        <input type="text" class="form-control" name="keywords[]"  data-role="tagsinput" placeholder="add tags" />
                                                    </div>
                                ...
                                <div class="col-md-3" id="sticky-conent">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input name="publish_date" value="{{Carbon\Carbon::parse(now())}}" type="datetime-local" class="form-control">
                                            </div>
                                        </div>
                                        @endif
                                        @if(Auth::user()->role_id == 1)
