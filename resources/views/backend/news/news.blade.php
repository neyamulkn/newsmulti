    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('news.store')}}" enctype="multipart/form-data"  data-parsley-validate  method="post" id="news">
                        @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input name="publish_date" value="{{Carbon\Carbon::parse(now())->format('Y-m-d\TH:m:s')}}" type="datetime-local" class="form-control">
                                            </div>
                                        </div>
                                      
                                        <div class="col-md-12">
                                           <div class="form-group">
                                                <label class="required" for="user_id">Reporter</label>
                                                <select required="" name="user_id"  id="user_id" class="form-control custom-select">
                                                    <option value=""> Select Reporter</option>
                                                    @foreach($reporters as $reporter)
                                                        <option value="{{$reporter->user_id}}" {{ ($reporter->user_id == old('user_id')) ? 'selected' : '' }}>{{$reporter->user->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                         ...
                                         <div class="col-md-12" >
                                            <div class="head-label">
                                                <label class="dropify_image_area" >Breaking News</label>
                                                <div >
