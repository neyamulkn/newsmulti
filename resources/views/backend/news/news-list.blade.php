                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <select name="seller" required id="seller" style="width:100%" id="seller"  class="select2 form-control custom-select">
                                                       ...
                                                       <option value="{{$repoter->user_id}}">{{$repoter->user->name}}</option>
                                                       @endforeach
                                                   </select>
                                               </div>
                                            </div>
                                               ...
                                               <td><img src="{{asset('upload/images/thumb_img/'.$show_news->source_path)}}" width="100"></td>
                                                ...
                                                <td>
                                                    <div class="bt-switch" title="News current status {{$show_news->status}}">
                                                        <input onchange="newApproveUnapprove({{$show_news->id}})" type="checkbox" {{($show_news->status != 'pending') ? 'checked' : ''}} data-on-color="success" data-off-color="danger" data-on-text="Published" data-off-text="Unpublish"> 
