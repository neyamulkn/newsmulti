...
@section('css')
    ...
    <link href="{{asset('backend')}}/assets/node_modules/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.min.css" rel="stylesheet" />
...
@section('js')
    ...
    <script src="{{asset('backend')}}/assets/node_modules/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.js" type="text/javascript"></script>
