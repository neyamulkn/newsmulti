                                        ...
                                        <tbody>
                                            ...
                                            <tr id="item{{$show_reporter->id}}">
                                                ...
                                                <td>
                                                    ...
                                                    <a title="View Profile" href="{{route('user_profile', $show_reporter->user->username)}}" class="btn btn-success btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> </a>

                                                    <a title="Edit Profile" href="{{ route('reporter.edit', $show_reporter->user_id)}}" class="btn btn-info btn-sm"><i class="ti-pencil" aria-hidden="true"></i></a>

                                                    <button title="Rejected request" data-target="#delete" onclick="confirmPopup('{{ $show_reporter->user_id }}')" class="btn btn-danger btn-sm" data-toggle="modal"><i class="ti-trash" aria-hidden="true"></i></button>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
