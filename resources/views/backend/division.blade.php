            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Division List</h4>
                    </div>
                                    ...
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr id="item{{$data->id}}">
                                                <td>{{$data->name_bd}}</td>
                                                <td>{{$data->name_en}}</td>
                                                <td>{{$data->MainCategory->category_bd}}</td>
                                                <td><div class="custom-control custom-switch">
                                                        <input name="status" type="checkbox" class="custom-control-input" {{($data->status == 1) ? 'checked' : ''}} id="status{{$data->id}}">
                                                        <label style="padding: 8px 15px;" class="custom-control-label" for="status{{$data->id}}"></label>
                                                    </div></td>
                                                <td>
            ...
            <div class="modal-dialog">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body form-row">
                        <div class="card-body">
                            <form action="{{route('division.store')}}" method="POST" class="floating-labels">
                                {{csrf_field()}}
                                <div class="form-body">
                                    <!--/row-->
                                    <div class="row justify-content-md-center">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input  name="name_bd" id="name_bd" value="{{old('name_bd')}}" required="" type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="name_en">English Name</label>
                                                <input  name="name_en" id="name_en" value="{{old('name_en')}}" required="" type="text" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select name="parent_id" required id="parent_id" class="form-control custom-select">
                                                    <option value=""></option>
...
@section('js')
    ...
    function deleteItem(id) {
        ...
        var link = '{{route("division.delete", ":id")}}';
