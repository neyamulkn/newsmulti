...
// * $bn = new banglaYear(strtotime('18-03-1988'), 0);
//  * or
//  * $bn = new banglaYear(time(), 6);
//  * or
...
class banglaYear {
    ...
    private $bn_months = array("Poush", "Magh", "Falgun", "Choitro", "Baishakh", "Joishţho", "Ashaaŗ", "Srabon", "Bhadro", "Ashswin", "Kartik", "Ôgrohaeon");
    ...
    function __construct( $timestamp, $hour = 6 ) {
        $this->banglaYear( $timestamp, $hour );
    }
    /*
     ...
     * @param type $hour
     */
    function banglaYear( $timestamp, $hour = 6 ) {
