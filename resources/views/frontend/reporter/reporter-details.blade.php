										...
										<div class="autor-box">
											<div class="row">
												<div class="col-xs-4 col-sm-2">
													<img src="{{asset('upload/images/users/thumb_image/'. $reporter->photo)}}" alt="{{$reporter->username}}">
												</div>
												<div class="col-xs-8 col-sm-10">
													<span><a style="color: #fff;font-weight: bold;" href="{{route('user_profile', $reporter->username)}}">{{$reporter->name}} </a></span><br/>
