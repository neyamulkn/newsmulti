...
if($section->section_type == 'category' || $section->section_type == 'country-wide'){
    ...
    $query->where('status', '=', 1)->orderBy('id', 'DESC')->limit(9); }, 'newsByCategory.image', 'newsByCategory.getCategory:id,category_bd,category_en', 'newsByCategory.subcategoryList:id,subcategory_bd,subcategory_en']);
}   
