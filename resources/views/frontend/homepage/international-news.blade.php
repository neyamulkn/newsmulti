            ...
            <div class="col-md-3 section-body" id="sticky-conent">
                ...
                <div class="sidebar large-sidebar">
                    ...
                    <div class="col-md-12">
                        <div class="news-post image-post2">
						    <div class="post-gallery">
						        <img src="{{ asset('upload/images/thumb_img_box/'. $communication->source_path)}}" alt="">
						        <div class="hover-box">
						        <div class="inner-hover">
                	...
                	<div class="col-md-12 col-xs-6">
					    <ul class="list-posts">
					        <li>
					            <img style="" src="{{ asset('upload/images/thumb_img_box/'. $communication->source_path)}}" alt="">
					            <div class="post-content">
