    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-6 col-xs-12 ">
            <div class="card loginArea">
                <div class="card-body">
                    <div id="loginform">
                        <form action="{{route('reporterLogin')}}" data-parsley-validate method="post">
                            @csrf
                            <div class="card-header text-center"><h3>Reporter Login</h3></div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="emailOrMobile" placeholder="Enter Email or Mobile Number " id="input-email" required="" data-parsley-required-message = "Email or Mobile number is required" class="form-control">
                            ...
                            <div class="form-group m-b-0">
                                <div class="col-sm-12 text-center">
                                    Don't have an account? <a href="{{ route('reporterRegister') }}" class="text-info m-l-5"><b>Sign Up</b></a>
                                </div>
                            </div> 
                        </form>
                    </div>  
                    <form class="form-horizontal" method="post" id="recoverform" action="{{ route('reporter.password.recover') }}">
                        @csrf
                        <div class="form-group ">
                            <div class="col-xs-12">
