        ...
        <div class="navbar-collapse">
            ...
            <ul class="navbar-nav my-lg-0">
                                     ...
                                     @foreach($notifications->take(7) as $notification)
                                        ...
                                        @if($notification->type == env('REPORTER_NOTIFY'))
                                            @if($notification->user)
                                                @if(Auth::guard('reporter')->user()->role_id != env('reporter'))
                ...
                <li class="nav-item dropdown u-pro">
                    <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{asset('upload/images/users/thumb_image/'. Auth::guard('reporter')->user()->photo)}}" alt="user" class=""> <span class="hidden-md-down"> &nbsp;<i class="fa fa-angle-down"></i></span> </a>
