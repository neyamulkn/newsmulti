    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('reporter.news.update', $get_news->id)}}" enctype="multipart/form-data" class="floating-labels" method="post" id="news">
                        @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group" style="display: flex;">
                                                <input disabled="" required="" type="text" value="{{$get_news->news_slug }}" style="width:90%" name="news_slug" id="news_slug" class="form-control" >
                                                <span style="border: 1px solid #ccc; padding: 5px; line-height: 25px;background: #efefef;cursor: pointer;" class="news_slug" onclick="enable()">Edit</span> 
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input name="publish_date" value="{{ date_create($get_news->publish_date)->format('Y-m-d\TH:i:s')}}" required type="datetime-local" class="form-control">
                                            </div>
                                        </div>
                                           ...
                                           <div class="form-group">
                                                ...
                                                <select name="user_id"  id="user_id" class="form-control custom-select">
                                                    @foreach($reporters as $reporter)
                                                        <option value="{{$reporter->id}}" {{ ($reporter->id == $get_news->user_id) ? 'selected' : '' }}>{{$reporter->user->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                        ...
                        <div class="form-actions pull-right">
                            <button type="submit" id="uploadBtn" name="submit" value="update" class="btn btn-success"> <i class="fa fa-save"></i> Update News</button>
                            ...
                            <form action="{{route('photo.upload')}}" id="imageUploadForm" method="post" class="floating-labels" enctype="multipart/form-data">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group" id="upload-file">
                                        <input type="file" class="dropify" onchange="uploadselectImage()" required="required" accept="image/*" data-type='image' data-allowed-file-extensions="jpg png PNG gif"  data-max-file-size="2M"  name="photo" id="input-file-events">
                                    </div>
                                </div>
